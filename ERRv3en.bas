...
IF s04=1 % Local Magnetic Field ////////////////
 ...
 mfy$= CHR$(0)+ FORMAT$("#####",mfy)+"y"
 mfz$= CHR$(0)+ FORMAT$("###",  mfz)+"z"
 ! % Vector ////////////
...
!
 ...
 IF s09=1
  ...
  IF mfy < -mfmx THEN TONE 5000, 56
  IF mfx > mfmx THEN TONE 10000, 56
  IF mfx < -mfmx THEN TONE 5000, 56
  IF mfz > mfmx THEN TONE 10000, 56
...
gm01$="Normal" 
gm02$="Magnetic Poles +/-" 
gm03$="Density Threshold="+FORMAT$("###.#",ggw)+"G"
gm04$="Indicator Sensitivity= "+INT$(mfi) 
